...
hoistedDependencies:
  ...
  /@apollo/server-plugin-landing-page-graphql-playground/4.0.0(@apollo/server@4.9.3):
    '@apollo/server-plugin-landing-page-graphql-playground': private
  ...
  /@nestjs/mapped-types/2.0.2(@nestjs/common@10.2.6)(reflect-metadata@0.1.13):
  ...
  /cosmiconfig/7.1.0:
    cosmiconfig: private
  /create-jest/29.7.0(@types/node@20.7.1)(ts-node@10.9.1):
    create-jest: private
  ...
  /jest-circus/29.7.0:
    jest-circus: private
  /jest-cli/29.7.0(@types/node@20.7.1)(ts-node@10.9.1):
    jest-cli: private
  /jest-config/29.7.0(@types/node@20.7.1)(ts-node@10.9.1):
    jest-config: private
  /jest-diff/29.7.0:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Fri, 29 Sep 2023 04:27:37 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  - /fsevents/2.3.3
storeDir: /home/theekshana/.local/share/pnpm/store/v3
